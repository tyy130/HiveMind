...
used for Flask Inter-process communication between backend and simulation script

Implement simple commands through the file system/response pattern:
1. Flask Write command to commands/ Directory
2. Simulation script polling command directory,Execute the command and write the response to responses/ Directory
3. Flask Poll the response directory for results
"""
...
class SimulationIPCClient:
    """
    Simulation IPC client(Flask terminal use)
    ...
    def send_command(
        ...
        # timeout
        logger.error(f"wait IPC Response timeout: command_id={command_id}")
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Optional platform selection.
                ...
                - None: Interview both platforms for a dual-platform simulation,
                  or the active platform for a single-platform simulation.
            timeout: Timeout in seconds.

        Returns:
            IPCResponse whose result field contains the interview results.
        """
        args = {
            "agent_id": agent_id,
            "prompt": prompt
...
class SimulationIPCServer:
    """
    Simulation IPC server(Simulate script usage)
