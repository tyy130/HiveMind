...
class IPCHandler:
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict]) -> bool:
        ...
        try:
            ...
            actions = {}
            agent_prompts = {}  # record each agent of prompt
...
class TwitterSimulationRunner:
    ...
    def _get_profile_path(self) -> str:
        """get Profile file path(OASIS Twitter use CSV Format)"""
    ...
    def _get_active_agents_for_round(
        ...
        # According to each Agent The configuration calculates the activation probability of
        candidates = []
    ...
    async def run(self, max_rounds: int = None):
        ...
        print(f"  - Agent Quantity: {len(self.config.get('agent_configs', []))}")
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(f"  warning: unable to Agent {agent_id}Create initial post: {e}")
        ...
        for round_num in range(total_rounds):
            ...
            # Get activated in this round Agent
        ...
        print(f"  - Total time spent: {total_elapsed:.1f}seconds")
...
async def main():
    ...
    # in main Created at the beginning of the function shutdown event
