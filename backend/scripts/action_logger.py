"""
action logger
for recording OASIS In the simulation each Agent action,For backend monitoring use
...
class SimulationLogManager:
    ...
    Unified management of all log files,Separate by platform
    """
...
class ActionLogger:
    ...
    Recommended SimulationLogManager instead of
    """
