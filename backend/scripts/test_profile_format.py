"""
test Profile Does the format generation comply with OASIS request
Verify:
1. Twitter Profile generate CSV Format
2. Reddit Profile generate JSON detailed format
"""
